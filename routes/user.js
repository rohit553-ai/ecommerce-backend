...
userRouter.post(
  ...
  messageValidator,
  checkErrors,
  wrapAsync(userController.sendMessages)
);
userRouter.get(
  "/my/orders",
  verifyLogin,
...
userRouter.get(
  "/my/wish-list",
  verifyLogin,
  wrapAsync(userController.getMyWishList)
);
userRouter.delete(
  "/my/wish-list/:id",
  verifyLogin,
  wrapAsync(userController.deleteMyWish)
);
userRouter.post(
  "/new-wish",
  verifyLogin,
  wrapAsync(userController.addProductToWishList)
);
